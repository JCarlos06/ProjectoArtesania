<%-- 
    Document   : Collares
    Created on : 11 jun. 2024, 17:22:56
    Author     : efe
--%>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="Controller?accion=Ceramica">Ceramica</a></li>
                                <li><a class="dropdown-item" href="Controller?accion=Vestimenta">Vestimenta</a></li>
                                <li><a class="dropdown-item" href="Controller?accion=Collares">Collares</a></li>
